...
/**
 * CategoryViewController implements the CRUD actions for MenuItems model.
 */
class CategoryViewController extends BaseController
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new MenuItemsQuery();
